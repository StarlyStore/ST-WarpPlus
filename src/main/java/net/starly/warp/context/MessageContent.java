package net.starly.warp.context;
...
public class MessageContent {
    ...
    public Optional<String> getMessageAfterPrefix(MessageType type, String key) {
        return getMessage(type, key).map(message -> getPrefix() + message);
    }
    ...
    public String getPrefix() { return getMessage(MessageType.NORMAL, "prefix").orElse(""); }
}
